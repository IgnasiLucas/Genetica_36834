...
Algunos años antes del redescubrimiento del trabajo de Gregor Mendel, Francis
Galton había estado estudiando la herencia de caracteres cuantitativos, como
la altura en humanos o el tamaño de las semillas de alguna planta. Una de sus
conclusiones fue la llamada *ley de la regresión hacia la mediocridad* [@Galton1886].
Lo que esta *ley* empírica viene a decir es que en cualquier carácter que podamos
medir en una población, los individuos suelen manifestar valores de ese carácter
menos extremos que los de sus progenitores. Por ejemplo, una pareja muy alta
tiende a tener descendencia más baja que ellos mismos; mientras que una pareja
muy baja tiende a tener descendencia más alta que ellos. Este acercamiento al
valor medio de la población motivó el uso del término *regresión* (a la mediocridad),
palabra que terminó por significar la técnica estadística inventada por Galton.

```{r Galton, echo=FALSE}

```

Galton interpretó esta observación como evidencia de que los caracteres no se
heredaban íntegramente del padre y de la madre, sino también de todos los ancestros
anteriores de un individuo. Esta concepción de la herencia como algo fluído, que
se mezcla y que incluye una parte procedente de ancestros remotos era difícil de reconciliar
con la visión Mendeliana de factores discretos, provenientes sólo del padre y de
la madre. El problema no era sólo el hecho de que Mendel
se había fijado en caracteres cualitativos y Galton, en caracteres cuantitativos.
En este sentido, era obvio también para Galton que un carácter como la estatura
humana estaba *compuesto* por multitud caracteres, y que como consecuencia de ello
la variación en estatura sería contínua, incluso si cada componente de la estatura
estuviera determinado por factores Mendelianos. De todos modos, los experimentos
de Herman Nilsson-Ehle demostraron elegantemente que la variación continua no
se contradecía con los principios de herencia Mendeliana.

## Experimentos de Herman Nilsson-Ehle
...
se mide en una escala contínua. Si cualquier otro gen implicado en el carácter es
monomórfico en la población y todos los indivíduos experimentan exactamente el mismo
ambiente, entonces habrá dos (con dominancia completa) o tres fenotipos posibles.
...
*aditivo* o heredable de los alelos (el valor genotípico *estimado*, $\hat{G}$) y una
...
Donde $\mu_G$ es el valor genotípico **medio** en la población, $\alpha_1$ y $\alpha_2$ son los
